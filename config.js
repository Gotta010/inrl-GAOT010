...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '50943468231';
...
global.gurl =  process.env.GURL || 'https://youtube.com/c/SuhailTechInfo' ; // Xky.jace_3.0
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : 'null,50943468231';
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'Xky.jace_3.0',
  ownername: process.env.OWNER_NAME || `It'x Gotta010`,
  author: process.env.PACK_AUTHER || '',
  packname: process.env.PACK_NAME || "", // \t   Xky.jace_3.0
  ...
  caption: process.env.CAPTION || "Xky.jace_3.0",   //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'Xky.jace_3.0',
